namespace GDB.App.Infrastructure.Repositories.Queries
{
    internal static class AccountQueries
    {
        ...
        public const string GetAccount = "GetAccountt";
        ...
        public const string InsertSavingsAccount = "InsertSavingsAccount";

        public const string InsertCurrentAccount = "InsertCurrentAccount";

        public const string InsertFixedDepositAccount = "InsertFixedDepositAccount";

        public const string InsertSalaryAccount = "InsertSalaryAccount";
